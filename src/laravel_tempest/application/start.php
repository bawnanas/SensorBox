...
Autoloader::directories(array(
	path('app').'models',
	path('app').'libraries',
	path('app').'models/rooms',
	path('app').'models/devices',
	path('app').'models/temperatures',
	path('app').'models/contacts',
	path('app').'models/assignments',
	path('app').'models/carriers',
	path('app').'models/devicetypes',
	path('app').'models/users',
	path('app').'models/temperaturedeltas',
));
